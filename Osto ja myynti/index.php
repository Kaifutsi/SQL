...
echo "(<a href='lisaailmoitus.php'>Lisää ilmoitus</a>) - (<a href='tiedot.php'>Muuta
...
echo "Hae ilmoituksia:<br> <form action='haeilmoitus.php' method='post'><input name='haku' type='text'><input type='submit' name='submit' value='Hae'></form></p>";
